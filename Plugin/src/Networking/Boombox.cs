...
public static class Boombox
{
    ...
    {
        NetworkManager.Singleton.CustomMessagingManager.RegisterNamedMessageHandler(SyncStateServerRpcMessage,
            OnSyncStateServerRpc);
        NetworkManager.Singleton.CustomMessagingManager.RegisterNamedMessageHandler(SyncStateClientRpcMessage,
            OnSyncStateClientRpc);
    ...
    public static void SyncStateServerRpc(NetworkObjectReference boomboxReference, bool playing, int track)
    {
        ...
        NetworkManager.Singleton.CustomMessagingManager.SendNamedMessage(SyncStateServerRpcMessage,
        ...
        ulong[] targets = null)
    {
        ...
        if (targets == null)
            ...
            NetworkManager.Singleton.CustomMessagingManager.SendNamedMessage(SyncStateClientRpcMessage, targets,
                buffer);
    }
